...
from ..schemas.experiment import ExperimentCreate, ExperimentUpdate, ExperimentRead
from ..models.experiment import Experiment


class ExperimentService(BaseService[Experiment, ExperimentCreate, ExperimentUpdate, ExperimentRead]):
        ...
        try:
            ...
            for exp in experiments:
                try:
                    ...
                    result.append(self.read_schema.model_validate({
                        "id": exp.id,
                        "film_id": exp.film_id,
