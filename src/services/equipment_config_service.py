...
from ..schemas.equipment_config import EquipmentConfigCreate, EquipmentConfigUpdate, EquipmentConfigRead
from ..models.equipment_config import EquipmentConfig


class EquipmentConfigService(BaseService[EquipmentConfig, EquipmentConfigCreate, EquipmentConfigUpdate, EquipmentConfigRead]):
    """Equipment configuration service."""
