...
class ExperimentRepository(CachedRepositoryImpl[Experiment], ExperimentRepositoryInterface[Experiment]):
    ...
    async def get_by_id_with_relations(self, id: UUID, session: AsyncSession) -> Optional[Experiment]:
    ...
    async def get_by_user_id(self, user_id: UUID, session: AsyncSession, skip: int = 0, limit: int = 100) -> List[Experiment]:
    ...
    async def get_by_film_id(self, film_id: UUID, session: AsyncSession, skip: int = 0, limit: int = 100) -> List[Experiment]:
    ...
    async def get_by_config_id(self, config_id: UUID, session: AsyncSession, skip: int = 0, limit: int = 100) -> List[Experiment]:
    ...
    async def get_with_images(self, id: UUID, session: AsyncSession) -> Optional[Experiment]:
    ...
    async def get_all_with_relations(self, session: AsyncSession, skip: int = 0, limit: int = 100) -> List[Experiment]:
    ...
    async def get_by_user_id_cached(self, user_id: UUID, session: AsyncSession, skip: int = 0, limit: int = 100) -> List[Experiment]:
