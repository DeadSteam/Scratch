...
class FilmBase(SchemaBase):
    ...
    coating_name: str | None = Field(None, max_length=100, description="Coating material name")
...
class FilmCreate(FilmBase):
    ...
    @classmethod
    def validate_thickness_with_coating(cls, v: float | None, info: ValidationInfo) -> float | None:
